...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=fuxEzIyS#sW9166UAy8gboiSGpAxvmP-AGc6efN574CWXNT6B4ls' : process.env.SESSION_ID,
...
NEWS_JID: process.env.NEWS_JID === undefined ? "120363371470281192@g.us" : process.env.NEWS_JID,
